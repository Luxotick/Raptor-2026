...
public class CANFuelSubsystem extends SubsystemBase {
  ...
  public CANFuelSubsystem() {
    launcher_motor = new SparkMax(42, MotorType.kBrushless);
  ...
  public void launch() {
    intake_motor.setVoltage(SmartDashboard.getNumber("Launching feeder roller value", LAUNCHING_FEEDER_VOLTAGE));
    launcher_motor
  ...
  public void spinUp() {
    intake_motor
        .setVoltage(SmartDashboard.getNumber("Spin-up feeder roller value", LAUNCHING_FEEDER_VOLTAGE));
    launcher_motor
        .setVoltage(SmartDashboard.getNumber("Launching launcher roller value", LAUNCHING_LAUNCHER_VOLTAGE));
  }
